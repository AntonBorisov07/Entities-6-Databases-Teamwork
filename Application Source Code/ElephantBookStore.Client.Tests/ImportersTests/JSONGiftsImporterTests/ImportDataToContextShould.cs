...
namespace ElephantBookStore.Client.UnitTests.ImportersTests.JSONGiftsImporterTests
{
	[TestClass]
	public class ImportDataToContextShould
	{
		...
		{
			var importer = new JSONGiftsImporter();
			importer.ImportJSONToDBContext(null, ValidFileName);
		}
		...
		public void ThrowArgumentException_WhenFileIsNull()
		{
			...
			var importer = new JSONGiftsImporter();
			importer.ImportJSONToDBContext(mockedContext.Object, null);
		}
		...
		public void ThrowArgumentException_WhenFileIsEmpty()
		{
			var mockedContext = new Mock<IBookStoreContext>();
			var importer = new JSONGiftsImporter();
			importer.ImportJSONToDBContext(mockedContext.Object, string.Empty);
		}
		...
		public void ThrowArgumentException_WhenFileNameIsInvalid()
		{
			...
			var mockedContext = new Mock<IBookStoreContext>();
			var importer = new JSONGiftsImporter();
			importer.ImportJSONToDBContext(mockedContext.Object, invalidFileName);
		}
		...
		public void ThrowFileNotFoundException_WhenFileDoesntExist()
		{
			...
			importer.ImportJSONToDBContext(mockedContext.Object, fileName);
		}
